...
export const TTSVideoForm: React.FC<TTSVideoFormProps> = ({
    ...
    // OmniVoice: 'instruct' = style text, 'clone' = ref audio WAV cloning
                                        ...
                                        {omnivoiceCloneSource === 'preset' ? (
                                            ...
                                            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.6rem' }}>
                                                <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
                                                    <button
                                                        type="button"
                                                        onClick={() => document.getElementById('omnivoice-file-upload-tts')?.click()}
                                                        style={{
